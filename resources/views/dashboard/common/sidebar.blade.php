<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                <img src="{{asset('dashboard/theme')}}/images/user.png" width="48" height="48" alt="User" />
            </div>
            @if (Auth::guard('admin')->user())
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{Auth::guard('admin')->user()->role ?? ""}}</div>
                <div class="email">{{ Auth::guard('admin')->user()->email }}</div>
                <div class="btn-group user-helper-dropdown">
                    <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>

                    <ul class="dropdown-menu pull-right">
                        <li><a href="{{route('admin.profile-setting.show',Auth::guard('admin')->user()->id)}}"><i class="material-icons">person</i>{{__('Profile')}}</a></li>
...
{{--                </li>--}}
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2021  <a href="{{route('admin.home')}}">Admin - Important Date</a>.
            </div>
            <div class="version">
                <b>Version: </b> 1.0.0
            </div>
